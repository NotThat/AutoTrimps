...
//EQUIPMENT HAS ITS OWN DAMAGE CALC SECTION:
    ...
    if(game.global.soldierHealth < 0.15*enemyDamage && game.global.soldierHealth > 1000){ //lets try buying more health if current health < 15% enemy attack, but not if 0 because we're dead
