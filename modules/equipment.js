...
//Run a quick Time estimate and if we complete it in 25 seconds or less, use 1/10th of our cap just so we can continue (MODULES["equipment"].capDivisor=10;)
    ...
    if (gameResource.level < 25 && MODULES["equipment"].alwaysLvl2) {
...
//EQUIPMENT HAS ITS OWN DAMAGE CALC SECTION:
    ...
    if(game.global.soldierHealth < 0.35*enemyDamage && game.global.soldierHealth > 1000){ //lets try buying more health if current health < 35% enemy attack, but not if 0 because we're dead
