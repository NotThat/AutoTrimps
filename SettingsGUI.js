...
function automationMenuInit() {
    ...
    newContainer.setAttribute("onmouseover", 'tooltip(\"Health to Damage ratio\", \"customText\", event, \"When HD ratio goes above limit it will trigger mapping for up to 10 map bonus.<p><b>poisonMult: </b>\" + poisonMult + \"<br><b>windMult: </b>\" + windMult +\"<br><b>Base HD ratio limit: </b>\" + enoughDamageCutoff +\"<br><b>Threshhold = </b>\" + threshhold.toFixed(0) + \"<br><b>H:D ratio: </b>\" + HDratio +\"<br>")');
    newContainer.setAttribute("onmouseout", 'tooltip("hide")');
...
//CORE:
    ...
    createSetting('NoCoordBuyStartZ', 'Start no Coord Buy', 'From this zone, stop buying coord upgrades until we get 1 additional Amalgamator. Disable with -1.', 'value', -1, null, 'Core');
...
//Heirloom Settings
    ...
    createSetting('HeirloomSwapping', 'Advanced Heirloom Swapping', 'Enables heirloom swapping (Endgame only feature). You need a 5/5 shield and a 2/5 shield that has exactly Plaguebringer and Void Maps and no damage mods. With this enabled the script will juggle between them for optimal windstacking. I recommend having Plaguebringer about the same level on both shields. Backup your game before using this.', 'boolean', false, null, 'Heirlooms');
