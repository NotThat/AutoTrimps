...
//CORE:
    ...
    createSetting('AutoFinishDailyNew', 'Finish Daily Z Mod', 'Modifies your normal auto portal zone in dailies. Accepts negative numbers as well, which will make you portal sooner on dailies. To disable AutoPortal during a Daily, turn off the AutoPortal option or set this to <b>999</b>!', 'valueNegative', 999, null, 'Core');
...
//AutoMaps + VoidMaps settings:
    ...
    createSetting('VoidMapsDailyMod', 'VMs Daily Modifier', 'Adds this value to your normal VM map in dailies. Accepts negative values as well. Disable with 999', 'valueNegative', '0', null, "Maps");
