...
//AutoMaps + VoidMaps settings:
    ...
    createSetting('PlusMapVoidToggle', 'Plus Maps for Voids', '<b>-1/0 = Off<br>Max Value is 10!!!</b><br>If this is on, AT will grab a prestigious map X zones up, and run it once (to grab the dagger prestige). This is independent of the new special map mods button that Gen is testing. I cba to make this \'smart\' and actively calculate what zone to go for...<br>Values above 10 will NOT work at all. Advise 1-5.', 'value', '0', null, 'Maps');
...
//Heirloom Settings
    ...
    createSetting('dontCarryJunkHeirlooms', ['Dont Carry Extra Heirlooms', 'Carry Extra Heirlooms'],'Will carry/not carry extra heirlooms in bags. Useful for maximizing available Nu', 'boolean', 0, null, 'Heirlooms');
