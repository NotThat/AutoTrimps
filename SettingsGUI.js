...
//Heirloom Settings
    ...
    createSetting('HeirloomSwapping', 'Heirloom Swapping', 'Enables heirloom swapping (Endgame only feature). You need a 5/5 shield and a 2/5 shield that has exactly Plaguebringer and Void Maps and no damage mods. With this enabled the script will juggle between them for optimal windstacking. I recommend having Plaguebringer about the same level on both shields. Backup your game before using this.', 'boolean', false, null, 'Heirlooms');
